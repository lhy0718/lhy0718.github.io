...
- **점수 할당**:
  ...
  - 표현식: $$p_c^i = \sigma(\text{softmax}(W_C^i \cdot H_l^i))$$ 
    ...
    - $N$은 면주 카테고리 수, $$\sigma(\cdot)$$는 점수의 연결 작업.
...
- 본 연구는 여러 중요한 요소를 밝혀냈습니다.
- 다양한 방법론을 통해 실험을 설계하였습니다.
- 결과는 시각적으로 표현되어 이해를 돕습니다.
- 연구 결과는 다음 방정식으로 요약될 수 있습니다: $$y = mx + b$$.
- 이 연구는 향후 연구 방향에 대한 제안도 포함합니다.
- 지속적인 피드백과 협업이 중요하다는 점을 강조합니다. 
- 최종적으로 연구 결과는 다음과 같은 영향을 미칠 것입니다: $$E = mc^2$$.

---

# CRediT authorship contribution statement

- 저자들은 이 논문에 보고된 작업에 영향을 미칠 수 있는 알려진 재정적 이해관계나 개인적 관계가 없음을 선언합니다.
...
- 데이터는 요청 시 제공될 예정입니다.
- 감사의 말씀: 본 연구는 리아오닝성 사회과학재단의 지원을 받았습니다 (번호: L20BTQ008).
- 모든 저자들은 최종 원고를 읽고 승인했습니다.