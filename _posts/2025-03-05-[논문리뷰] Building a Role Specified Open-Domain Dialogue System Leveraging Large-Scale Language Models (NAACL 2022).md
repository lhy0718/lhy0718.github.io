...
- 이 연구에서는 역할 지정 오픈 도메인 대화(RSODD) 시스템 방법을 연구함.
...
- 이 방법은 수작업으로 금 대화를 제작하는 것보다 데이터 세트 구축 비용을 크게 줄일 수 있음.
...
- CLOVA 및 NAVER AI Lab의 모든 구성원에게 감사 인사
  - 특히 Gichang Lee, Hwijeen Ahn 및 CLOVA 대화 팀원에게 감사
- 챗봇의 역할 설계에 도움을 준 Hyeri Kim, Hyunjung Park, Yuin Jeong에게 감사
- 기술적 지원을 제공한 Jeeseung Han에게 감사
- 프로젝트에 대한 지원 및 유용한 의견을 준 Nako Sung에게 감사